...
```go
import (
    "github.com/binlake/siddontang/go-mysql/replication"
    "os"
)
...
You can see [go-mysql-elasticsearch](https://github.com/binlake/siddontang/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch. 
...
```go
import (
    "github.com/binlake/siddontang/go-mysql/client"
)
...
```go
import (
    "github.com/binlake/siddontang/go-mysql/server"
    "net"
)
...
import (
    ...
    _ "github.com/binlake/siddontang/go-mysql/driver"
)
...
|PayPal|微信|
|------|---|
|[![](https://www.paypalobjects.com/webstatic/paypalme/images/pp_logo_small.png)](https://paypal.me/siddontang)|[![](https://github.com/binlake/siddontang/blog/blob/master/donate/weixin.png)|
